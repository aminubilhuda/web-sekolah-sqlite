        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <nav class="hidden md:flex items-center space-x-4">
                    <a href="/" class="{{ request()->is('/') ? 'text-blue-600 font-medium' : 'text-gray-600' }} hover:text-blue-600 transition-colors">Beranda</a>
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <a href="/profile" class="block px-4 py-2 {{ request()->is('profile/sekolah*') ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-blue-50' }}">Profile Sekolah</a>
                            <a href="/hubungan-industri" class="block px-4 py-2 {{ request()->is('profile/hubungan-industri*') ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-blue-50' }}">Hubungan Industri</a>
                        </div>
                    </div>
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open"
            ...
            <div id="mobile-menu" class="md:hidden py-4 border-t border-gray-200 hidden">
                <nav class="flex flex-col space-y-4">
                    ...
                    <a href="#" class="text-gray-600">Penerimaan</a>
                    <a href="#" class="text-gray-600">Acara</a>
                    <a href="#" class="text-gray-600">Galeri</a>
                    <a href="#" class="text-gray-600">Tentang Kami</a>
                    <a href="#" class="text-gray-600">Kontak</a>
                    <div class="flex flex-col space-y-2 pt-4 border-t border-gray-200">
                        <button class="flex items-center space-x-2 text-gray-600 justify-center py-2">
                            <i data-lucide="user" class="w-4 h-4"></i>
                            <span>Masuk</span>
                        </button>
                        <button

                    ...
                    @foreach($hubins as $hubin)
                        <div class="bg-gray-50 rounded-xl p-6 card-hover border border-gray-200">
                            <div class="flex items-center mb-4">
                                @if($hubin->logo)
                                    <img src="{{ asset('storage/' . $hubin->logo) }}" alt="{{ $hubin->nama_perusahaan }}" class="w-12 h-12 rounded-lg mr-4">
                                @else
                            ...
                            <div class="space-y-2 mb-4">
                                ...
                                @if($hubin->website)
                                    <div class="flex items-center text-sm text-gray-600">
                                        ...
                                        <a href="{{ $hubin->website }}" target="_blank" class="text-blue-600 hover:text-blue-800">{{ $hubin->website }}</a>
                                    </div>
                                @endif
                            </div>
